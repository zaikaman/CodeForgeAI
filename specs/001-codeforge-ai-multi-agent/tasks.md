...
- [x] **T075** [P] Implement LeadEngineerAgent in `backend/src/agents/base/LeadEngineerAgent.ts` (orchestrator, AgentBuilder.withModel('gpt-5-mini-2025-08-07'), system prompt)
...
- **Model**: Use `AgentBuilder.withModel('gpt-5-mini-2025-08-07')` for all agents
