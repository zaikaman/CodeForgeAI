...
- [x] **T075** [P] Implement LeadEngineerAgent in `backend/src/agents/base/LeadEngineerAgent.ts` (orchestrator, AgentBuilder.withModel('gpt-5-mini'), system prompt)
...
- **Model**: Use `AgentBuilder.withModel('gpt-5-mini')` for all agents
