...
### 2. LLM: OpenAI gpt-5-mini-2025-08-07

**Decision**: Exclusively use OpenAI's gpt-5-mini-2025-08-07 model for all LLM calls via ADK-TS
...
const agent = await AgentBuilder
  .withModel('gpt-5-mini-2025-08-07')  // Just specify model name
  .withTemperature(0.2)
  .withMaxTokens(4096)
  .build();
```
...
**Configuration**:
- Model: `gpt-5-mini-2025-08-07` (passed to `AgentBuilder.withModel()`)
